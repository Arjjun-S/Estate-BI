/**
 * Database Seed Script for EstateBI
...
async function seed() {
    ...
    try {
        ...
        // Create database
        await connection.query('CREATE DATABASE IF NOT EXISTS estatebi');
        await connection.query('USE estatebi');
        console.log('✅ Database selected: estatebi');
        ...
        if (fs.existsSync(schemaPath)) {
            ...
            const cleanSchema = schema
                .replace(/CREATE DATABASE IF NOT EXISTS estatebi;/gi, '')
                .replace(/USE estatebi;/gi, '');
        ...
        await connection.query(`
            ...
            ('Admin User', 'admin@estatebi.com', ?, 'admin'),
            ('Arjun S', 'arjun@estatebi.com', ?, 'analyst')
        ...
        `);
        console.log('✅ Upload history created');
        
        console.log('\n========================================');
        console.log('🎉 Database seeded successfully!');
        console.log('========================================');
        console.log('\n📋 Login Credentials:');
        console.log('   Email: admin@estatebi.com');
        console.log('   Password: admin123');
        console.log('\n   Email: arjun@estatebi.com');
        console.log('   Password: admin123');
        console.log('========================================\n');
